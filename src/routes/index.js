...
import {
  ChartLine, AdProduct, MessageOne, System, GraphicDesign, Rss, ExperimentOne,
...
export default [
  ...
  {
    path: '/notice', title: '消息中心', component: Notice, icon: MessageOne,
  },
  {
    path: '/page2', title: '业务办理', component: Page, icon: System,
  },
  {
    path: '/editor', title: '图像编辑', component: Page, icon: GraphicDesign,
  },
  {
    title: '嵌套菜单',
    icon: Rss,
